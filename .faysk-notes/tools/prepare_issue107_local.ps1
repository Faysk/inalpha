...
$Files = [ordered]@{
    ...
    ".faysk-notes/tools/issue107_sustained_mixed_probe.py" = "services/factor/issue107_sustained_mixed_probe.py"
    ".faysk-notes/tools/issue107_sustained_acceptance_probe.py" = "services/factor/issue107_sustained_acceptance_probe.py"
...
Write-Host "Factor/mixed benchmarks must use services/factor/issue107_factor_app.py and pass issue107_target_check.py first."
Write-Host "Use issue107_sustained_acceptance_probe.py for cross-sectional sustained acceptance evidence."
